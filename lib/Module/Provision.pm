# @(#)Ident: Provision.pm 2013-08-02 18:44 pjf ;

package Module::Provision;

use 5.01;
use namespace::sweep;
use version; our $VERSION = qv( sprintf '0.17.%d', q$Rev: 20 $ =~ /\d+/gmx );
...
This documents version v0.17.$Rev: 20 $ of L<Module::Provision>
