# @(#)Ident: Provision.pm 2013-07-29 16:08 pjf ;

package Module::Provision;

use 5.01;
use namespace::sweep;
use version; our $VERSION = qv( sprintf '0.17.%d', q$Rev: 17 $ =~ /\d+/gmx );
...
This documents version v0.17.$Rev: 17 $ of L<Module::Provision>
