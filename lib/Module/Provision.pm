# @(#)Ident: Provision.pm 2013-07-29 23:50 pjf ;

package Module::Provision;

use 5.01;
use namespace::sweep;
use version; our $VERSION = qv( sprintf '0.17.%d', q$Rev: 18 $ =~ /\d+/gmx );
...
This documents version v0.17.$Rev: 18 $ of L<Module::Provision>
